/*
 * ! jQuery Form Plugin version: 2.47 (04-SEP-2010) @requires jQuery v1.3.2 or
 * later
 * 
...
(function($) {
	...
	$.fn.ajaxForm = function(options) {
		...
		return this.ajaxFormUnbind().bind('submit.form-plugin', function(e) {
					if (!e.isDefaultPrevented()) { // if event has been
													// canceled, don't proceed
						e.preventDefault();
