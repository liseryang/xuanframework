...
<x:tbody title="计划模板" iconCls="icon-dot">
  <div id="p" class="easyui-panel" title="基本信息" icon="icon-edit" style="padding:2px; margin-bottom:2px;background:#fafafa;">
    <table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
      <tr>
        ...
        <td class="td_context"><input name="receipt_memo_number_condition" type="text" id="receipt_memo_number_condition" value="20101124001"/>
        </td>
        <td class="td_title">模板名称*</td>
        <td class="td_context"><input name="receipt_memo_number_condition3" type="text" id="receipt_memo_number_condition3" value="测试模板-数据业务网"/></td>
        <td class="td_title">模板类型*</td>
        <td class="td_context"><select class="easyui-combobox" name="select2">
            <option>---未选择---</option>
            <option selected="selected">动态行</option>
            <option>固定行</option>
          </select></td>
      </tr>
      <tr>
        <td height="21" class="td_title">公司类型*</td>
        <td class="td_context"><input name="planStatus22" class="easyui-combobox" value="TD公司" url="/json/companyType_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" /></td>
      ...
      <td class="td_context"><span class="td_title">创建时间</span></td>
    </tr>
      <tr>
  ...
  <div id="p" class="easyui-panel" title="类别定义" icon="icon-analysis" collapsible="true" style="padding:2px; margin-bottom:2px;background:#fafafa;">
    <table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
      <tr>
  ...
  <div id="p" class="easyui-panel" title="模板数据映射" icon="icon-analysis" collapsible="true" style="padding:2px; margin-bottom:2px;background:#fafafa;">
