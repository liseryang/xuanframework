...
<x:tbody title="地市年度计划查询" iconCls="icon-dot">
  <x:grid id="first" hql="from AnnualInvestmentPlan" idfield="planId"
		sortName="planNum" onDblClickRow="windowOpen('查看计划', '/car.htm');" needCk="false">
	...
	<x:grm iconCls="icon-search" handler="windowOpen('查看', '/c/jsp/programManagement/annualPlanView');" text="查看计划"/>
