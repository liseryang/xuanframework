...
<table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
 ...
 <tr>
  ...
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('提交给内审部送审！');">提交</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">退回</a><a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">重置</a></div>
</x:tbody>
