...
<x:tbody title="项目结算申请--提交审计报告" iconCls="icon-dot">
...
<tr>
    ...
    <tr>
      <td height="21" class="td_title">建设/施工单位意见</td>
      <td class="td_context" colspan="5">建设/施工单位意见</td>
    </tr>
