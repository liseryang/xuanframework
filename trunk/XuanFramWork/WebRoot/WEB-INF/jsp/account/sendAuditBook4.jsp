...
<x:tbody title="项目决算审计--提交审计报告初稿" iconCls="icon-dot">
...
<table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
 ...
 <tr>
  ...
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('提交建设单位/财务部确认！');">提交</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">退回</a>
