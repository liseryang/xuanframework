...
<x:tbody title="项目决算申请--提交决算审计报告" iconCls="icon-dot">
...
<table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
 ...
 <tr>
  ...
  <table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
    ...
    <tr>
      <td height="21" class="td_title">建设单位/财务部意见</td>
      <td class="td_context" colspan="5">建设单位/财务部意见</td>
    </tr>
    
	  <tr>
      <td height="21" class="td_title" width="10%">送审金额</td>
      <td class="td_context"><input name="programManager" value="5000" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" /></td>
      <td height="21" class="td_title" width="10%">审定金额</td>
      <td class="td_context"><input name="programManager" value="5000" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" /></td>
      <td height="21" class="td_title" width="10%">审增金额</td>
      <td class="td_context"><input name="programManager" value="100" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" /></td>
    </tr>
    <tr>
    	<td height="21" class="td_title" width="10%">审减金额</td>
      <td class="td_context"><input name="programManager" value="300" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" /></td>
      <td height="21" class="td_title">违规金额</td>
      <td class="td_context"><input name="programManager2" value="200" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" /></td>
      <td class="td_title">审计发现问题</td>
      <td class="td_context"><input name="programManager3" value="5" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" />
        <span class="td_context">个</span></td>
    </tr>
    <tr>
      <td height="21" class="td_title">节约成本（投资）</td>
      <td class="td_context"><input name="programManager22" value="5000" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" /></td>
      <td class="td_title">提出管理建议</td>
      <td class="td_context"><input name="programManager32" value="5" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" />
        条
      </td>
      <td class="td_title">决算审计报告文号</td>
      <td class="td_context"><input name="programManager32" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" /></td>  
    </tr>
    
    <tr>
    	<td class="td_title">审计人天</td>
      <td class="td_context"><input name="programManager2" url="/json/programManager_data.json"	valuefield="id" textfield="text" editable="false"panelheight="auto" />人.日</td>
      <td height="21" class="td_title">审计费</td>
      ...
      <td class="td_context"><input type="file" name="file" /></td>  
   	...
   	<tr>
   		<td height="21" class="td_title">已拨金额</td>
      <td class="td_context"><input type="text" value="222323.00"></td>
      <td class="td_title">应拨补+应上交-</td>
      <td class="td_context"><input type="text" value="1222.00"></td>
      <td class="td_title">审计单位报告属性</td>
  ...
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('提交内审部！');">提交</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">退回</a></div>
</x:tbody>
