...
<x:tbody title="项目结算申请--施工单位" iconCls="icon-dot">
...
<table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
  <tr>
    ...
    <td width="40%" class="td_context">省建项目测试
      <input type="reset" name="button2" id="button2" value="选择项目"  class="inputSubmit" onclick="popWin('选择项目', '/c/jsp/account/projectList', 'icon-search', 780, 300);" /></td><td width="10%" class="td_title">项目编号</td>
 ...
 <tr>
  ...
  <table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
    <tr>
      <td class="td_title" width="10%">施工单位</td>
      <td class="td_context" width="20%">XXX施工单位</td>
      <td class="td_title" width="10%">施工单位资质</td>
      <td class="td_context" width="20%">系统集成2级</td>
      <td class="td_title" width="10%">施工单位负责人</td>
  ...
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('提交给项目经理送审！');">提交</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">重置</a></div>
</x:tbody>
