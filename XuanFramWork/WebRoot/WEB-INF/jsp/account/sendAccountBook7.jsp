...
<x:tbody title="项目结算申请--内审部确认" iconCls="icon-dot">
...
<tr>
  ...
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('提交财务部门！');">提交</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">退回</a></div>
</x:tbody>
