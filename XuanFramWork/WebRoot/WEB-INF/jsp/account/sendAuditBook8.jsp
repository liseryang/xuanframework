...
<x:tbody title="项目决算审计--补充供应链订单号" iconCls="icon-dot">
 ...
 <tr>
  ...
  <table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
    ...
    <tr>
      ...
      <td height="21" class="td_title" width="10%">审定金额(审计单位)</td>
    ...
    <tr>
      ...
      <td class="td_context">5
        条
      </td>
      <td class="td_title">决算审计报告文号</td>
      <td class="td_context">2010110008</td>  
    </tr>
    <tr>
    	<td height="21" class="td_title">已拨金额</td>
      <td class="td_context">222323.00</td>
      <td class="td_title">应拨补+应上交-</td>
      <td class="td_context">1222.00</td>
      <td class="td_title">外聘审计</td>
      <td class="td_context">30 人.日</td>
    </tr>
    <tr>
    	<td height="21" class="td_title">外聘审计费</td>
      <td class="td_context">6000.00</td>
       <td class="td_title" >自行审计</td>
      <td class="td_context" >12
        人.日</td>
    	<td height="21" class="td_title">核定审计费</td>
      <td class="td_context">9800</td>
    </tr>
    <tr>
    	<td height="21" class="td_title">审定金额(内审部)</td>
      <td class="td_context">12000</td>
    	<td class="td_title">审计报告属性</td>
      <td class="td_context">保留意见</td>
  		<td class="td_title">供应链订单号</td>
      <td class="td_context"><input type="test" name="file" /></td>
  	</tr>
  	<tr>
  		<td class="td_title">附件</td>
  ...
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('保存成功！');">保存</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">退回</a></div>
</x:tbody>
