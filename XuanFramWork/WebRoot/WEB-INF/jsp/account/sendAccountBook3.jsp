...
<x:tbody title="项目结算申请--选择审计单位" iconCls="icon-dot">
 ...
 <tr>
  ...
  <table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
    ...
    <tr>
      ...
      <td colspan="5" class="td_context"><a href="#">施工单位申请.doc</a> &nbsp;<a href="#">建设单位附件.doc</a></td>
    </tr>
    ...
    <tr>
      ...
      <td class="td_context" colspan="5"><select name="select">
      	<option>内审部</option>
       	<option>中介机构</option>
        <option>中介机构1</option>
        <option>中介机构2</option>
  ...
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('提交中介审计！');">提交审计单位</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">退回</a>
