...
<x:tbody title="项目结算申请--建设单位" iconCls="icon-dot">
...
<table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
 ...
 <tr>
  ...
  <table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
    ...
    <tr>
      <td class="td_title">甲供设备及材料费*</td>
      <td class="td_context"><input name="Input22" id="Input22" /></td>
      ...
      <td class="td_context" width="40%"><label>
        <input type="checkbox" name="checkbox" value="checkbox" />
        土建</label><label>
        <input type="checkbox" name="checkbox" value="checkbox" />
        通讯</label><label>
    ...
    <tr>
      ...
      <td colspan="5" class="td_context"><a href="#">施工单位申请.doc</a></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="td_title">意见</td>
      <td colspan="5" class="td_context"><textarea name="textarea" style="width:98%"></textarea></td>
      </tr>
  </table>
  </div>
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('提交给审计员送审！');">同意</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">退回</a>
