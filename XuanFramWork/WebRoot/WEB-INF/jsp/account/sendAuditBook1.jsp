...
<x:tbody title="项目决算审计申请" iconCls="icon-dot">
 ...
 <tr>
  ...
  <table class="userInput_table" cellspacing="0" cellpadding="0" border="1" style="margin: 1 auto; width: 100%;">
    ...
    <tr>
      ...
      <td class="td_context"><input type="text" name="textfield" value="省建项目测试决算审计工单"/></td>
    </tr>
    <tr>
  ...
  <div align="center"><a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="alert('提交给财务部送审！');">提交</a> <a href="#" class="easyui-linkbutton" iconcls="icon-undo" onclick="">重置</a></div>
</x:tbody>
