...
<x:tbody title="滚动规划" iconCls="icon-dot">
  <x:grid id="first" hql="from RollingPlan" idfield="id"
		sortName="id" onDblClickRow="window.location.href='/c/jsp/programManagement/rollingPlanEdit';">
	...
	<x:gtb text="上传" iconCls="icon-up" handler="popWin('滚动规划文件上传', '/c/jsp/programManagement/rollingPlanEdit', 'icon-file',640,380);"/>
	...
	<x:grm iconCls="icon-save" handler="alert('下载');" text="下载"/>
