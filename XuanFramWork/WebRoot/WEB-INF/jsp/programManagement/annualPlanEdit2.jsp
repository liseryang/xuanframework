...
%>
<x:tbody title="年度计划调整-总部" iconCls="icon-dot">
...
<td class="td_title" width="10%">GSM核心网2011年建设计划</td>
  <td class="td_context"><a href="#" class="easyui-linkbutton" plain="true" iconcls="icon-analysis">计划汇总表</a> <a href="#" class="easyui-linkbutton" plain="true" iconcls="icon-doc">部门1</a> <a href="#" class="easyui-linkbutton" plain="true" iconcls="icon-doc">部门2</a> <a href="#" class="easyui-linkbutton" plain="true" iconcls="icon-doc">部门3</a>  </td>
  </tr>
  <tr>
...
<table width="1608" class="easyui-datagrid" id="tt1" style="width:auto;height:auto;">
  <thead>
    <tr>
      ...
      <th width="103" field="name9"><strong>操作</strong></th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td><div align="right">20000.00</div></td>
      <td><div align="right">20000.00</div></td>
      <td><a href="#" class="easyui-linkbutton" plain="true" iconcls="icon-doc" onclick="popWin('项目分摊', '/c/jsp/programManagement/projectApportion', 'icon-search', 640, 480);">分摊</a></td>
    </tr>
    ...
    <tr>
      ...
      <td><div align="right"><span style="color:blue">20000.00</span></div></td>
      <td><div align="right"><span style="color:blue">20000.00</span></div></td>
      <td><a href="#" class="easyui-linkbutton" plain="true" iconcls="icon-doc">重新分摊</a></td>
    </tr>
    ...
    <tr>
      ...
      <td><div align="right">20000.00</div></td>
      <td><div align="right">20000.00</div></td>
      <td><a href="#" class="easyui-linkbutton" plain="true" iconcls="icon-doc">分摊</a></td>
    </tr>
    <tr>
      <td>部门2</td>
